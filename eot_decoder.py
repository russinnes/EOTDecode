...
def printEOT(EOT):
    ...
    print("---------------------\n")
    print("Unit Address:   {}\n".format(EOT.unit_addr), file=sys.stderr)
    print("Pressure:       {} psig\n".format(EOT.pressure), file=sys.stderr)
    print("Motion:         {}\n".format(EOT.motion), file=sys.stderr)
    print("Marker Light:   {}\n".format(EOT.mkr_light), file=sys.stderr)
    print("Turbine:        {}\n".format(EOT.turbine), file=sys.stderr)
    print("Battery Cond:   {}\n".format(EOT.batt_cond_text), file=sys.stderr)
    print("Battery Charge: {}\n".format(EOT.batt_charge), file=sys.stderr)
    print("Arm Status:     {}\n".format(EOT.arm_status), file=sys.stderr)
